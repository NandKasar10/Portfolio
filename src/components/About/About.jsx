...
import profileImage from "../../assets/pc2.jpg";
    ...
    >
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          ...
          {/* Resume Button */}
          <a
            href="https://docs.google.com/document/d/1QKkNIjCHPvkIiBR3eBBLAA1_ALvloTbA/edit?usp=drive_link&ouid=118369073269241436200&rtpof=true&sd=true"
            target="_blank"
          ...
          <a
            href="https://drive.google.com/file/d/1yhIL0zJdttkzLqM00x5TikjVJf2E6lgl/view?usp=drive_link"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block text-white py-3 px-8 rounded-full mt-5 text-lg font-bold transition duration-300 transform hover:scale-105"
            style={{
